<template>
  <div class="mx-auto">
    <h2 class="text-lg font-medium text-gray-900">Absen</h2>
    <div
      ...
      <table class="min-w-full divide-y divide-gray-300">
        <thead class="bg-indigo-500">
          <tr>
            <th
              scope="col"
              class="py-2.5 text-left text-xs font-semibold text-white sm:pl-6"
            >
              No.
            </th>
            <th
              scope="col"
              class="pr-3 py-2.5 text-left text-xs font-semibold text-white"
            >
              Nama Guru
            </th>
            <th
...
const { absen, indexAbsen } = useAbsen();
let i = 1;
