<template>
    <div class="max-w-auto mx-auto">
        <h2 class="text-lg font-medium text-gray-900">Create Mata Pelajaran</h2>
                    ...
                    <div class="px-4 py-5 bg-white p-6">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6">
                                <label for="mapel" class="block text-xs font-medium text-gray-700">Nama Mata
                                    Pelajaran</label>
                                <input type="text" v-model="form.mapel"
