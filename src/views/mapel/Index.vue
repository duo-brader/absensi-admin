<template>
    <div class="mx-auto">
        <h2 class="text-lg font-medium text-gray-900">Mata Pelajaran</h2>
        <div class="flex items-center flex-col lg:flex-row lg:justify-end gap-3 mt-3">
            <router-link :to="{ name: 'mapel-create' }"
        ...
        <div class="mt-4 overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:-mx-6 md:mx-0 md:rounded-lg">
            <table class="min-w-full divide-y divide-gray-300">
                <thead class="bg-indigo-500">
                    <tr>
                        <th scope="col" class="py-2.5 text-center text-xs font-semibold text-white sm:pl-6">
                            No.
                        </th>
                        <th scope="col" class="pr-3 py-2.5 text-center text-xs font-semibold text-white">
                            Nama Mapel
                        </th>
                    ...
                    <tr>
                        ...
                        <td class="pl-3 py-2 text-xs text-gray-500 lg:table-cell">
                            <div class="flex justify-center gap-5">
                                <router-link :to="{ name: 'mapel-edit' }"
